...
export const detailFields={
 car:['fuel','transmission','body','engine','color','drive','condition','credit','barter','vin'],
...
export const detailLabels={fuel:'Yanacaq',transmission:'Sürətlər qutusu',body:'Ban növü',engine:'Mühərrik (litr)',color:'Rəng',drive:'Ötürücü',condition:'Vəziyyət',credit:'Kredit',barter:'Barter',vin:'VIN',part_type:'Detalın növü',oem:'Detal kodu (OEM)',fitment:'Uyğunluq qeydi',service_type:'Xidmət növü',hours:'İş saatları',insurance_type:'Sığorta növü',insurer:'Sığorta şirkəti',plate_number:'Qeydiyyat nişanı'};
