...
async function setup(){
 ...
 const run=new Function('window','document','location','navigator','crypto','setInterval','clearInterval','shared','args',source);
 await run(w,w.document,w.location,w.navigator,w.crypto,fn=>{clock=fn;return 1;},()=>{},shared,args);
